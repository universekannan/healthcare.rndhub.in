        ...
        <legend className="scheduler-border">
          <ul className="navbar-nav">
            ...
            <li className="nav-item d-none d-sm-inline-block col-md-1">
              <a href="./dashboard">
                <img src="./dist/img/icon/opd.png" style={{width: 50}} /><br />
                <label>Dashboard</label>
              </a>
            </li>
            <li className="nav-item d-none d-sm-inline-block col-md-1">
            <img src="./dist/img/icon/user.png" style={{width: 50}} /><br />
            ...
            <li className="nav-item d-none d-sm-inline-block col-md-1">
              <a href>
                <img src="./dist/img/icon/admission.png" style={{width: 50}} /><br />
                <label>Admission</label>
              </a>
            </li>
            <li className="nav-item d-none d-sm-inline-block col-md-1">
              <a href>
                <img src="./dist/img/icon/billing.png" style={{width: 50}} /><br />
                <label>Billing</label>
              </a>
            </li>
            <li className="nav-item d-none d-sm-inline-block col-md-1">
              <a href>
                <img src="./dist/img/icon/pharmacy.png" style={{width: 50}} /><br />
            ...
            <li className="nav-item d-none d-sm-inline-block col-md-1">
              <a href>
                <img src="./dist/img/icon/setting.png" style={{width: 50}} /><br />
              </a><div className="dropdown"><a href>
                </a><a className="dropbtn">
            ...
            <li className="nav-item d-none d-sm-inline-block col-md-1">
              <img src="./dist/img/icon/logout.png" style={{width: 50}} /><br />
              <div className="dropdown">
