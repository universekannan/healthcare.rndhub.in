               ...
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                           <input required="required" type="number" min="1" max="12" class="form-control" name="month" id="month" maxlength="50" placeholder="MM">
                        </div>
                        <div class="col-sm-2">
                           <input required="required" type="number" class="form-control" name="days" id="days" min="1" max="31" placeholder="DD">
                        </div>
                        <div class="col-sm-2">
